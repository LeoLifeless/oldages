...
import net.mcreator.samuraiswords.entity.renderer.CorruptedSamuraiRenderer;
import net.mcreator.samuraiswords.SamuraiswordsModElements;

@SamuraiswordsModElements.ModElement.Tag
public class CorruptedSamuraiEntity extends SamuraiswordsModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("corrupted_samurai").setRegistryName("corrupted_samurai");

	public CorruptedSamuraiEntity(SamuraiswordsModElements instance) {
		super(instance, 53);
		FMLJavaModLoadingContext.get().getModEventBus().register(new CorruptedSamuraiRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -11198171, -16777214, new Item.Properties().group(SamuraiSwordsItemGroup.tab))
				.setRegistryName("corrupted_samurai_spawn_egg"));
	}
