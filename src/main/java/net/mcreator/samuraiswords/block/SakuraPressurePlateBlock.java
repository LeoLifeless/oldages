...
public class SakuraPressurePlateBlock extends SamuraiswordsModElements.ModElement {
	@ObjectHolder("samuraiswords:sakura_pressure_plate")
	public static final Block block = null;

	public SakuraPressurePlateBlock(SamuraiswordsModElements instance) {
		super(instance, 36);
	}
