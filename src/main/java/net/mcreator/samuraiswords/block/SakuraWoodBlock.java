...
public class SakuraWoodBlock extends SamuraiswordsModElements.ModElement {
	@ObjectHolder("samuraiswords:sakura_wood")
	public static final Block block = null;

	public SakuraWoodBlock(SamuraiswordsModElements instance) {
		super(instance, 28);
	}
