...
public class SakuraLogBlock extends SamuraiswordsModElements.ModElement {
	@ObjectHolder("samuraiswords:sakura_log")
	public static final Block block = null;

	public SakuraLogBlock(SamuraiswordsModElements instance) {
		super(instance, 29);
	}
