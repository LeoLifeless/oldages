...
public class SakuraFenceBlock extends SamuraiswordsModElements.ModElement {
	@ObjectHolder("samuraiswords:sakura_fence")
	public static final Block block = null;

	public SakuraFenceBlock(SamuraiswordsModElements instance) {
		super(instance, 34);
	}
