...
public class SakuraStairsBlock extends SamuraiswordsModElements.ModElement {
	@ObjectHolder("samuraiswords:sakura_stairs")
	public static final Block block = null;

	public SakuraStairsBlock(SamuraiswordsModElements instance) {
		super(instance, 32);
	}
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new BlockItem(block, new Item.Properties().group(SamuraiSwordsItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
