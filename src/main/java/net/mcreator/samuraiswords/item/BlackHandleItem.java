...
public class BlackHandleItem extends SamuraiswordsModElements.ModElement {
	@ObjectHolder("samuraiswords:black_handle")
	public static final Item block = null;

	public BlackHandleItem(SamuraiswordsModElements instance) {
		super(instance, 19);
	}
