...
public class BlueKatanaItem extends SamuraiswordsModElements.ModElement {
	@ObjectHolder("samuraiswords:blue_katana")
	public static final Item block = null;

	public BlueKatanaItem(SamuraiswordsModElements instance) {
		super(instance, 14);
	}
