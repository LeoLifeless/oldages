...
public class BlueHandleItem extends SamuraiswordsModElements.ModElement {
	@ObjectHolder("samuraiswords:blue_handle")
	public static final Item block = null;

	public BlueHandleItem(SamuraiswordsModElements instance) {
		super(instance, 17);
	}
